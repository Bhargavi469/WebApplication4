...
namespace WebApplication4.Models
{
    public class usersaccountsController : Controller
    {
        ...
        public usersaccountsController(WebApplication4Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.usersaccounts != null ? 
                          ...
                          Problem("Entity set 'WebApplication4Context.usersaccounts'  is null.");
        }
        ...
        {
            SqlConnection conn1 = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\HP\\Documents\\db1.mdf;Integrated Security=True;Connect Timeout=30");
            string sql;
